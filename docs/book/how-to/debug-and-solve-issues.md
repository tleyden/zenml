...
* Understand the problem by studying the [additional logs](debug-and-solve-issues.md#client-and-server-logs) and [client/server logs](debug-and-solve-issues.md#client-and-server-logs).
