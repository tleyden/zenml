...
The [`DockerSettings`](./docker-settings-on-a-pipeline.md#specifying-docker-build-options) class in ZenML allows you to set a parent image to be used in your pipeline runs and gives the ability to skip building an image on top of it.
